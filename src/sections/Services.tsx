    ...
    <section id="servicos" className="relative py-16 lg:py-24 overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 md:px-8 relative z-10">
        ...
        <div className="mt-12 flex justify-center">
          <Reveal delayMs={460}>
            <a href="#contato" className="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-primary to-primary/80 px-6 py-3 text-primary-foreground font-semibold shadow-lg transition-all hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-1 active:translate-y-0">
